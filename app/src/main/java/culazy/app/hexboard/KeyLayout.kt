...
//            10 -> Input.sendDownUp(connection, KeyEvent.KEYCODE_ENTER)
            14 -> Input.sendDownUp(connection, KeyEvent.KEYCODE_Z, KeyEvent.META_CTRL_ON.or(KeyEvent.META_SHIFT_ON))
            15 -> Input.sendDownUp(connection, KeyEvent.KEYCODE_Z, KeyEvent.META_CTRL_ON)
